...
public class Player : MonoBehaviour
{
    ...
    void myStress() //플레이어의 스트레스 수치
    {
        ...
        Enemy_stage1 enemy2 = gameObject2.GetComponent<Enemy_stage1>();
        Enemy_stage1 enemy3= gameObject3.GetComponent<Enemy_stage1>();
        Enemy_stage1 enemy4 = gameObject4.GetComponent<Enemy_stage1>();

        //stage1 몬스터

        if ((enemy.attack == true|| enemy2.attack == true|| enemy3.attack == true|| enemy4.attack == true) &&enemy==true) //몬스터가 attack이라는 모션을 취하는 동시에 몬스터와 접촉을 해야 공격을 받음
        {
